...
export const raceData: Race[] = [
  ...
  { round: 20, country: 'Brazil', circuit: 'Autódromo José Carlos Pace (Interlagos)', date: '2026-11-08' },
  { round: 21, country: 'Las Vegas', circuit: 'Las Vegas Strip Circuit', date: '2026-11-21' },
  { round: 22, country: 'Qatar', circuit: 'Lusail International Circuit', date: '2026-11-29' },
  { round: 23, country: 'Abu Dhabi', circuit: 'Yas Marina Circuit', date: '2026-12-06' },
];
